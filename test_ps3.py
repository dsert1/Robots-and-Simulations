...
class ps3_P3(unittest.TestCase):
    """This  tests iRoom and Simple robot in various ways"""
    ...
    def test_BoundaryConditions(self):
        "Test strict inequalities in random positions for the iRoom and SimpleRobot"
        for m in range(7000):
...
"""The SIMULATION_TIME_LIMIT, SimulationThread class and SimulationTester class
    ...
    and passes the tests for SimpleRobot and iRoom, there should not be any
    additional issue.
"""
...
class ps3_P5_Simple(SimulationTester):
    """test the simulation time cleaning the iRoom with a SimpleRobot"""
    def testSimulation1(self):
        "Test cleaning 100% of a 5x5 room"
        try:
            self.run_simulation(((142, 174),), (1, 1.0, 1, 5, 5, 1, 1.0, 100, ps3.SimpleRobot))
        except:
            print ("Unexpected error:", sys.exc_info()[1])
            raise
    def testSimulation2(self):
        "Test cleaning 75% of a 10x10 room (Simple Robot)"
        self.run_simulation(((183, 198),), (1, 1.0, 1, 10, 10, 1, 0.75, 100, ps3.SimpleRobot))
    def testSimulation3(self):
        "Test cleaning 90% of a 10x10 room (Simple Robot)"
        self.run_simulation(((298, 327),), (1, 1.0, 1, 10, 10, 1, 0.9, 100, ps3.SimpleRobot))
    def testSimulation4(self):
        "Test multiple robots (95% of a 20x20 room with 5 robots (Simple Robot))"
        self.run_simulation(((289, 303),), (5, 1.0, 1, 20, 20, 1, 0.95, 100, ps3.SimpleRobot))
    def testSimulation5(self):
        "Test different speeds (90% of a 5x20 room with a robot of speed 0.2 (Simple Robot))"
        self.run_simulation(((1095, 1228),), (1, 0.2, 1, 5, 20, 1, 0.9, 100, ps3.SimpleRobot))
    def testSimulation6(self):
        "Test multiple robots and different speeds (90% of a 10x10 room with 3 robots of speed 0.5 (Simple Robot))"
        self.run_simulation(((155, 180),), (3, 0.5, 1, 10, 10, 1, 0.9, 100, ps3.SimpleRobot))
    # new tests below here
    def testSimulation7(self):
         "Test cleaning 100% of a 5x5 room (Simple Robot, 5 dirt/tile, capcity = 3)"
         self.run_simulation(((206, 266),(180, 240)), (1, 1.0, 3, 5, 5, 5, 1.0, 100, ps3.SimpleRobot))
    def testSimulation8(self):
        "Test cleaning 100% of a 5x5 room (Simple Robot, 6 dirt/tile, capacity = 3)"
        self.run_simulation(((206, 266),(180, 240)), (1, 1.0, 3, 5, 5, 6, 1.0, 100, ps3.SimpleRobot))
    def testSimulation9(self):
        """Test different speeds (90% of a 3x10 room with a robot of speed 0.2 (Simple Robot)),
        capacity = 2, 6 dirt/tile"""
        self.run_simulation(((387, 447),(384, 444)), (1, 0.2, 2, 3, 10, 6, 0.9, 100, ps3.SimpleRobot))
    def testSimulation10(self):
        "Test multiple robots (95% of a 10x10 room with 5 robots (Simple Robot)) capacity = 2, 6 dirt/tile"
        self.run_simulation(((137, 198),(130, 190)), (5, 1.0, 2, 10, 10, 6, 0.95, 100, ps3.SimpleRobot))
    def testSimulation11(self):
        """Test multiple robots and different speeds (90% of a 5x5 room with 3 robots of speed 0.5
        (Simple Robot)), capacity = 2, 6 dirt/tile"""
        self.run_simulation(((48, 108), (45, 104)), (3, 0.5, 2, 5, 5, 6, 0.9, 100, ps3.SimpleRobot))

class ps3_P5_OnSale(SimulationTester):
    """test the simulation time cleaning the iRoom with a OnSaleRobot"""
    def testSimulation1(self):
        "Test cleaning 100% of a 5x5 room with OnSaleRobot"
        x = ps3.run_simulation(1, 1.0, 1, 5, 5, 1, 1.0, 100, ps3.OnSaleRobot)
        self.assertTrue(237 <= x <= 295, "Simulation output was outside of 99.7% confidence interval!\n")
    def testSimulation2(self):
        "Test cleaning 75% of a 10x10 room with OnSaleRobot"
        x = ps3.run_simulation(1, 1.0, 1, 10, 10, 1, 0.75, 100, ps3.OnSaleRobot)
        self.assertTrue(217 <= x <=245, "Simulation output was outside of 99.7% confidence interval! Took " + str(x) + " steps\n") #todo - look into this
    def testSimulation3(self):
        "Test cleaning 90% of a 10x10 room with OnSaleRobot"
        x = ps3.run_simulation(1, 1.0, 1, 10, 10, 1, 0.9, 100, ps3.OnSaleRobot)
        self.assertTrue(399 <= x <= 442, "Simulation output was outside of 99.7% confidence interval! Took " + str(x) + " steps\n")
    def testSimulation4(self):
        "Test cleaning 100% of a 5x5 room with 2 OnSaleRobots"
        x = ps3.run_simulation(2, 1.0, 2, 5, 5, 5, 1.0, 100, ps3.OnSaleRobot)
        self.assertTrue(182 <= x <= 218, "Simulation output was outside of 99.7% confidence interval! Took " + str(x) + " steps\n")
    def testSimulation5(self):
        "Test cleaning 75% of a 10x10 room with 4 OnSaleRobots"
        x = ps3.run_simulation(4, 1.0, 3, 10, 10, 5, 0.75, 100, ps3.OnSaleRobot)
        self.assertTrue(98 <= x <= 104, "Simulation output was outside of 99.7% confidence interval! Took " + str(x) + " steps\n")
    def testSimulation6(self):
        "Test cleaning 90% of a 10x10 room with 5 OnSaleRobots"
        x = ps3.run_simulation(5, 1.0, 3, 10, 10, 10, 0.9, 100, ps3.OnSaleRobot)
        self.assertTrue(201 <= x <= 215, "Simulation output was outside of 99.7% confidence interval! Took " + str(x) + " steps\n")

class ps3_P5_Breathtaking(SimulationTester):
    """test the simulation time cleaning the iRoom with a OnSaleRobot"""
    def testSimulation1(self):
        "Test cleaning 100% of a 5x5 room with BreathtakingRobot"
        x = ps3.run_simulation(1, 1.0, 1, 5, 5, 1, 1.0, 100, ps3.BreathtakingRobot)
...
#    suite.addTest(unittest.makeSuite(ps3_P5_Simple))
#    suite.addTest(unittest.makeSuite(ps3_P5_OnSale))
    suite.addTest(unittest.makeSuite(ps3_P5_Breathtaking))
